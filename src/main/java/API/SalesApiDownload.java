...
public class SalesApiDownload {
    public static void downloadSales(String directoryReports, String dateFrom, String dateTo, String token) {
        String apiUrl = "https://seller-analytics-api.wildberries.ru/api/v1/analytics/region-sale?dateFrom=" + dateFrom + "&dateTo=" + dateTo;
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                String jsonPath = "e:\\Proga\\AnaliticsWBMain\\sales.json";
                ...
                JsonNode report = jsonNode.get("report");
                ArrayNode jsonArray = (ArrayNode) report;
                ...
                try (FileOutputStream outputStream = new FileOutputStream(directoryReports + "Продажи.xlsx")) {
                    workbook.write(outputStream);
                }
                workbook.close();
            } else {
                System.out.println("Ошибка HTTP продажи: " + responseCode);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
